---
title: "HW 07 - Fitting explanatory models on forest carbon fluxes"
output: 
  tufte::tufte_html:
    css: ../hw.css
...
-   Practice exploring model fits using ggplot
-   Practice fitting models using `{parsnips}` functions

## Data

```{r photo, fig.margin = TRUE, echo = FALSE, fig.width = 3, fig.cap = "Morgan Monroe State Forest, IN", eval = TRUE}
